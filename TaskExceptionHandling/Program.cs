...
Console.WriteLine("\nThis program is demonstrating - Task Exception Handling\n");
// 1. Exceptions in Tasks are hidden. 



using var client = new HttpClient();
//this link does not work on purpose. To run and get the HTTP response:
// change it to https://pokeapi.co/api/v2/pokemon
